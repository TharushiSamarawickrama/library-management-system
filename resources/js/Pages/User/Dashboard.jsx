        ...
        <div style={styles.page}>
            ...
            <main style={styles.main}>
                <div style={styles.topBar}>
                    ...
                    <Link href="/profile" style={styles.profileBox}>
                        ...
                        <div>
                            ...
                            <p style={styles.profileRole}>Library User</p>
                        </div>
                    </Link>
                </div>
                ...
                <div style={styles.heroCard}>
                    <div>
                        <span style={styles.heroBadge}>User Workspace</span>
                        ...
                        <p style={styles.heroText}>
                            Search available books, send borrow requests, and monitor your borrowed
                            books easily from one simple dashboard.
                        </p>
                    </div>
                ...
                <div style={styles.cardGrid}>
                    <Link href="/books" style={styles.card}>
                        ...
                        <p style={styles.cardText}>
                            Browse available books, check book details, and find books you want to borrow.
                        </p>
                    ...
                    <Link href="/borrow-requests" style={styles.card}>
                        ...
                        <p style={styles.cardText}>
                            View your pending, approved, and rejected borrow request status.
                        </p>
                    ...
                    <Link href="/borrowings" style={styles.card}>
                        <div style={styles.cardTop}>
                            ...
                            <span style={styles.cardBadgeGreen}>Borrowings</span>
                        </div>

                        <h3 style={styles.cardTitle}>My Borrowed Books</h3>

                        <p style={styles.cardText}>
                            Track borrowed books, due dates, return status, and borrowing history.
                        </p>
                ...
                <div style={styles.infoPanel}>
                    <div>
                        <h2 style={styles.infoTitle}>Library Activity Overview</h2>
                        <p style={styles.infoText}>
                            Use this dashboard to browse books, request borrowings, and view your
                            borrowing records in a clean and organized way.
                        </p>
                    </div>
