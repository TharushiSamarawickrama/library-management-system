...
export default function Index({ borrowings }) {
    ...
    return (
        <>
            <Head title={isAdmin ? 'Borrowing Records' : 'My Borrowed Books'} />
                ...
                <aside style={styles.sidebar}>
                    <div>
                        ...
                        <nav style={styles.nav}>
                            ...
                            <Link href="/borrowings" style={styles.activeNavLink}>
                ...
                <main style={styles.main}>
                    <div style={styles.topBar}>
                        <div>
                            ...
                            <p style={styles.subtitle}>
                                {isAdmin
                                    ? 'Track borrowed books, returned books, and manage book returns.'
                    ...
                    <div style={styles.heroCard}>
                        <div>
                            <h2 style={styles.heroTitle}>
                                {isAdmin ? 'Borrowing Management' : 'Borrowing History'}
                            </h2>
                            <p style={styles.heroText}>
                                {isAdmin
                                    ? 'Manage active borrowings, mark books as returned, and keep library records updated.'
                                    : 'Check your borrowed books and monitor due dates in one clean page.'}
                            </p>
                        </div>
                    ...
                    <div style={styles.statsGrid}>
                        <div style={styles.statCard}>
                            ...
                            <div>
                                <h3 style={styles.statTitle}>{borrowings.length}</h3>
                                <p style={styles.statText}>Total Records</p>
                            </div>
                        </div>
                        ...
                        <div style={styles.statCard}>
                            ...
                            <div>
                                <h3 style={styles.statTitle}>{borrowedCount}</h3>
                                <p style={styles.statText}>Currently Borrowed</p>
                            </div>
                        </div>
                        ...
                        <div style={styles.statCard}>
                            ...
                            <div>
                                <h3 style={styles.statTitle}>{returnedCount}</h3>
                                <p style={styles.statText}>Returned Books</p>
                            </div>
                        </div>
                        ...
                        <div style={styles.statCard}>
                            ...
                            <div>
                                <h3 style={styles.statTitle}>{overdueCount}</h3>
                                <p style={styles.statText}>Overdue Records</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={styles.contentCard}>
                        <div style={styles.tableHeader}>
                            <div>
                                <h2 style={styles.tableTitle}>
                                    {isAdmin ? 'All Borrowing Records' : 'My Borrowing Records'}
                                </h2>
                                <p style={styles.tableSubtitle}>
                                    Clean overview of borrowing information and return status.
                                </p>
                            </div>

                            <Link href="/borrow-requests" style={styles.requestButtonTop}>
                                Borrow Requests
                            </Link>
                        </div>
                        ...
                        {borrowings.length > 0 ? (
                            ...
                            <div style={styles.emptyBox}>
                                ...
                                <h3 style={styles.emptyTitle}>No borrowing records found</h3>
                                <p style={styles.emptyText}>
                                    {isAdmin
                                        ? 'No user has borrowed a book yet.'
