            ...
            <main style={styles.main}>
                ...
                <div style={styles.heroCard}>
                    <div>
                        ...
                        <p style={styles.heroText}>
                            Monitor library activities, manage book availability, and handle student borrowing requests efficiently.
                        </p>
                    </div>
                ...
                <div style={styles.cardGrid}>
                    ...
                    <Link href="/borrowings" style={styles.card}>
                        ...
                        <p style={styles.cardText}>
                            Track borrowed books and mark returned books.
                        </p>
                ...
                <div style={styles.quickSection}>
                    ...
                    <div style={styles.quickGrid}>
                        <Link href="/books/create" style={styles.quickButton}>
                            Add Book
                        </Link>
