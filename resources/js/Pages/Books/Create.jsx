            ...
            <div style={styles.page}>
                ...
                <main style={styles.main}>
                    <div style={styles.topBar}>
                        <div>
                            ...
                            <p style={styles.subtitle}>
                                Add a new book record to the library collection.
                            </p>
                        </div>
                    ...
                    <div style={styles.heroCard}>
                        <div>
                            <h2 style={styles.heroTitle}>Book Information</h2>
                            <p style={styles.heroText}>
                                Fill the book details carefully. These details will be displayed to users when they browse books.
                            </p>
                        </div>
                    ...
                    <div style={styles.formCard}>
                        <form onSubmit={submit}>
                            ...
                            <div style={styles.buttonRow}>
                                ...
                                >
                                    {processing ? 'Saving Book...' : 'Save Book'}
                                </button>
                            </div>
                        </form>
                    </div>
